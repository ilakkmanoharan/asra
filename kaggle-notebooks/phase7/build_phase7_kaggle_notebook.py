#!/usr/bin/env python3
"""Build Kaggle Phase 7 submission notebook from private/phase7/asra_phase7_my_agent.py."""
...
def main() -> None:
    ...
    agent_path = here / "asra_phase7_my_agent.py"
    out_path = here / "asra-phase-7-arc-prize-2026.ipynb"
...
if result.returncode != 0:
    print(result.stderr)
    raise RuntimeError('my_agent.py Phase 7 self-test failed')
print('Phase 7 my_agent self-test OK')'''
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# ASRA Phase 7 — Kaggle submission (ARC Prize 2026)\n\n",
                    "Phase 7 adds **goal inference and hypothesis ranking** on Phase 2–4 stacks.\n\n",
            ...
            {"cell_type": "markdown", "metadata": {}, "source": ["## 1. Write `my_agent.py` (Phase 7)"]},
            ...
            {"cell_type": "code", "metadata": {}, "source": [parquet_cell], "outputs": [], "execution_count": None},
            {
                ...
                "source": [
                    ...
                    "Spec: `private/phase7/phase7-goal-inference-hypothesis-engine.md`.",
                ],
            },
        ],
    }
