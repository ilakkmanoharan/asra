...
KERNEL_SLUG = "ilakkmanoharan/asra-phase-9-arc-prize-2026"
COMP = "arc-prize-2026-arc-agi-3"
NOTEBOOK = HERE / "asra-phase-9-arc-prize-2026.ipynb"
...
def push(client: KaggleClient) -> int:
    ...
    req.new_title = "ASRA Phase 9 — ARC Prize 2026"
    req.text = text
    req.language = "python"
...
def main() -> None:
    p = argparse.ArgumentParser(description="Push + submit ASRA Phase 9 Kaggle notebook")
    p.add_argument("--message", default="asra-v1.0-phase9")
