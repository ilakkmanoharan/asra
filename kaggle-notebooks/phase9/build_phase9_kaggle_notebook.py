#!/usr/bin/env python3
"""Build Kaggle Phase 9 submission notebook from private/phase9/asra_phase9_my_agent.py."""
...
def main() -> None:
    ...
    agent_path = here / "asra_phase9_my_agent.py"
    out_path = here / "asra-phase-9-arc-prize-2026.ipynb"
...
if result.returncode != 0:
    print(result.stderr)
    raise RuntimeError('my_agent.py Phase 9 self-test failed')
print('Phase 9 my_agent self-test OK')'''
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# ASRA Phase 9 — Kaggle submission (ARC Prize 2026)\n\n",
                    "Phase 9 adds **goal inference and hypothesis ranking** on Phase 2–4 stacks.\n\n",
            ...
            {"cell_type": "markdown", "metadata": {}, "source": ["## 1. Write `my_agent.py` (Phase 9)"]},
            ...
            {"cell_type": "code", "metadata": {}, "source": [parquet_cell], "outputs": [], "execution_count": None},
            {
                ...
                "source": [
                    ...
                    "Spec: `private/phase9/phase9-goal-inference-hypothesis-engine.md`.",
                ],
            },
        ],
    }
