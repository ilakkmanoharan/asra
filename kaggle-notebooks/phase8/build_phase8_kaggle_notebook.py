#!/usr/bin/env python3
"""Build Kaggle Phase 8 submission notebook from private/phase8/asra_phase8_my_agent.py."""
...
def main() -> None:
    ...
    agent_path = here / "asra_phase8_my_agent.py"
    out_path = here / "asra-phase-8-arc-prize-2026.ipynb"
...
if result.returncode != 0:
    print(result.stderr)
    raise RuntimeError('my_agent.py Phase 8 self-test failed')
print('Phase 8 my_agent self-test OK')'''
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# ASRA Phase 8 — Kaggle submission (ARC Prize 2026)\n\n",
                    "Phase 8 adds **goal inference and hypothesis ranking** on Phase 2–4 stacks.\n\n",
            ...
            {"cell_type": "markdown", "metadata": {}, "source": ["## 1. Write `my_agent.py` (Phase 8)"]},
            ...
            {"cell_type": "code", "metadata": {}, "source": [parquet_cell], "outputs": [], "execution_count": None},
            {
                ...
                "source": [
                    ...
                    "Spec: `private/phase8/phase8-goal-inference-hypothesis-engine.md`.",
                ],
            },
        ],
    }
