...
NOTEBOOK = HERE / "asra-phase-4-arc-prize-2026.ipynb"
...
def push(client: KaggleClient) -> int:
    ...
    req.new_title = "ASRA Phase 4 — ARC Prize 2026"
    req.text = text
    req.language = "python"
...
def main() -> None:
    p = argparse.ArgumentParser(description="Push + submit ASRA Phase 4 Kaggle notebook")
    p.add_argument("--message", default="ASRA v0.6-phase4 causal semantics hints")
