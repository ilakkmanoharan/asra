#!/usr/bin/env python3
"""Build Kaggle Phase 4 submission notebook from phase4/asra_phase4_my_agent.py."""
...
def main() -> None:
    ...
    agent_path = repo / "kaggle-notebooks" / "phase4" / "asra_phase4_my_agent.py"
    out_path = repo / "kaggle-notebooks" / "phase4" / "asra-phase-4-arc-prize-2026.ipynb"
...
if result.returncode != 0:
    print(result.stderr)
    raise RuntimeError('my_agent.py Phase 4 self-test failed')
print('Phase 4 my_agent self-test OK')'''
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# ASRA Phase 4 — Kaggle submission (ARC Prize 2026)\n\n",
                    "Phase 4 adds **causal action semantics** on Phase 2 object scenes + Phase 3 exploration memory.\n\n",
                    "- Action-effect signatures with transform histograms\n",
                    "- Transition prediction + epistemic uncertainty per action\n",
                    "- Counterfactual lookup for alternate actions\n",
                    "- Venv at `/tmp/asra_venv` — same bootstrap as Phase 2–3\n\n",
            ...
            {"cell_type": "markdown", "metadata": {}, "source": ["## 1. Write `my_agent.py` (Phase 4)"]},
            ...
            {"cell_type": "code", "metadata": {}, "source": [parquet_cell], "outputs": [], "execution_count": None},
            {
                ...
                "source": [
                    ...
                    "Library reference: `asra-arc/src/asra/causality/` — see `kaggle-notebooks/phase4/phase4-implementation.md`.",
                ],
            },
        ],
    }
