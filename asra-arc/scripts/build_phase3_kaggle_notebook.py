#!/usr/bin/env python3
"""Build Kaggle Phase 3 submission notebook from phase3/asra_phase3_my_agent.py."""
...
def main() -> None:
    ...
    agent_path = repo / "kaggle-notebooks" / "phase3" / "asra_phase3_my_agent.py"
    out_path = repo / "kaggle-notebooks" / "phase3" / "asra-phase-3-arc-prize-2026.ipynb"
...
# Do not mirror ARC-AGI-3-Agents to /kaggle/working (fills output quota; hides submission files).
...
if result.returncode != 0:
    print(result.stderr)
    raise RuntimeError('my_agent.py Phase 3 self-test failed')
print('Phase 3 my_agent self-test OK')'''
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# ASRA Phase 3 — Kaggle submission (ARC Prize 2026)\n\n",
                    "Phase 3 adds **exploration memory & novelty hints** on top of Phase 2 object-scene perception.\n\n",
                    "- Visit-count novelty and loop avoidance (`CompactExplorationHints`)\n",
                    "- Phase 2 compact object-scene bias retained\n",
                    "- Venv at `/tmp/asra_venv` (not `/kaggle/working`) — same bootstrap as Phase 2\n\n",
            ...
            {"cell_type": "markdown", "metadata": {}, "source": ["## 1. Write `my_agent.py` (Phase 3)"]},
            ...
            {"cell_type": "code", "metadata": {}, "source": [parquet_cell], "outputs": [], "execution_count": None},
            {
                ...
                "source": [
                    ...
                    "Library reference: `asra-arc/src/asra/exploration/` — see `kaggle-notebooks/phase3/phase3-implementation.md`.",
                ],
            },
        ],
    }
